...
docker build -t %CONTAINER_NAME%:v1 --build-arg AWS_ACCESS_KEY_ID=%aws_access_key_id% --build-arg AWS_SECRET_ACCESS_KEY=%aws_secret_access_key% --build-arg S3_FILE=%S3_FILE% .
